...
class TestMultiplier(TestCase):
    ...
    def test_compare_rate(self):
        ...
        model = keras.models.load_model(model_path, custom_objects={'LRMultiplier': LRMultiplier})
    ...
    def test_lr_plateau(self):
        ...
        model.compile(
            optimizer=LRMultiplier(keras.optimizers.Adam(), {'Output': 100.0}),
        ...
        model.fit(
            ...
            epochs=1000,
            callbacks=[
                keras.callbacks.ReduceLROnPlateau(patience=2, verbose=True),
